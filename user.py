...
def user():
    ...
    specific search parameters to gather the pieces you've been dreaming of, but couldn't quite name--
    ...
    To start curating your gallery, enter your search criteria below. You can specify as many or as few as you'd like!
